...
(function (window) {
    ...
    if (true) {
        // AMD
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1)], __WEBPACK_AMD_DEFINE_FACTORY__ = (defineBridget),
...
(function (w) {
	var E = w(window),
	    ...
	    A,
	    K;w(function () {
		w("body").append(w([H = w('<div id="lbOverlay" />').click(C)[0], a = w('<div id="lbCenter" />')[0], G = w('<div id="lbBottomContainer" />')[0]]).css("display", "none"));g = w('<div id="lbImage" />').appendTo(a).append(p = w('<div style="position: relative;" />').append([I = w('<a id="lbPrevLink" href="#" />').click(B)[0], d = w('<a id="lbNextLink" href="#" />').click(e)[0]])[0])[0];c = w('<div id="lbBottom" />').appendTo(G).append([w('<a id="lbCloseLink" href="#" />').click(C)[0], A = w('<div id="lbCaption" />')[0], K = w('<div id="lbNumber" />')[0], w('<div style="clear: both;" />')[0]])[0];
		...
		var N = E.scrollLeft(),
		    M = E.width();w([a, G]).css("left", N + M / 2);if (v) {
		...
		var N = O.which,
		    M = w.inArray;return M(N, u.closeKeys) >= 0 ? C() : M(N, u.nextKeys) >= 0 ? e() : M(N, u.previousKeys) >= 0 ? B() : null;
	}function B() {
		return b(x);
	}function e() {
		return b(D);
